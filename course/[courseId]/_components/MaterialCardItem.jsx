...
function MaterialCardItem({item,studyTypeContent,course,refreshData}) {
  ...
  const GenerateContent=async()=>{
    ...
    toast(' Sedang membuat konten kursus...')
    setLoading(true)
    // console.log(course)
    let chapters='';
    course?.courseLayout.chapters.forEach(chapter=>{
      chapters=(chapter.chapter_info.chapter_title||chapter.chapter_info.chapterTitle)+','+chapters
    });
    ...
    console.log(result);
    refreshData(true);
    toast('Kontenmu kursusmu sudah siap!')
