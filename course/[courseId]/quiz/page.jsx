    ...
    <div>
        ...
        {isCorrectAns==false&& <div>
            <div className='border p-3 border-red-700 bg-red-200 rounded-lg'>
                <h2 className='font-bold text-lg text-red-600'>Salah</h2>
                <p className='text-red-600'>Jawaban yang benar adalah : {correctAns}</p>
            </div>
        </div>}
       
        {isCorrectAns==true&& <div>
            <div className='border p-3 border-green-700 bg-green-200 rounded-lg'>
                <h2 className='font-bold text-lg text-green-600'>Benar</h2>
                <p className='text-green-600'>Jawabanmu benar</p>
            </div>
        </div>}
